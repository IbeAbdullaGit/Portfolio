...
import { Home, ProjectNexusESC, ProjectSpinCritters,ProjectRubbishRush, ProjectTheBeyond, ProjectXelify, ProjectDYNCPA, ProjectWavesTD} from "./pages";
    ...
    <section className="bg-slate-300">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/Portfolio/project/dyncpa" element={<ProjectDYNCPA/>}/>
